...
macro(langnes_json_add_options)
    ...
    option(LANGNES_JSON_PACKAGE_HEADERS "Package header components" "${LANGNES_JSON_PACKAGE}")
    option(LANGNES_JSON_PACKAGE_RUNTIME "Package runtime components" "${LANGNES_JSON_PACKAGE}")
    option(LANGNES_JSON_PACKAGE_C "Package C components" "${LANGNES_JSON_PACKAGE}")
    option(LANGNES_JSON_PACKAGE_CXX "Package C++ components" "${LANGNES_JSON_PACKAGE}")
