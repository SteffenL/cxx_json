...
macro(langnes_json_add_options)
    ...
    option(LANGNES_JSON_PACKAGE_HEADERS "Package C and C++ header components" "${LANGNES_JSON_PACKAGE}")
    option(LANGNES_JSON_PACKAGE_RUNTIME "Package runtime components" "${LANGNES_JSON_PACKAGE}")
    option(LANGNES_JSON_PACKAGE_LINK "Package development link components" "${LANGNES_JSON_PACKAGE}")
