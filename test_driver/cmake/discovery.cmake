set(LANGNES_JSON_TEST_DISCOVERY_DIR ${CMAKE_CURRENT_LIST_DIR})

function(langnes_json_discover_tests TARGET)
    ...
    set(TEST_DRIVER_INCLUDE_FILE "${LANGNES_JSON_TEST_DISCOVERY_DIR}/discovery.cmake")
    ...
    add_custom_command(
        ...
        COMMAND "${CMAKE_COMMAND}"
            ...
            -P "${LANGNES_JSON_TEST_DISCOVERY_DIR}/generate_includes.cmake"
...
function(langnes_json_discover_tests_impl TEST_DRIVER)
    execute_process(
